...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.current_bid'
        db.alter_column(u'app_invoice', 'current_bid_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['app.Offer']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Invoice.current_bid'
        raise RuntimeError("Cannot reverse this migration. 'Invoice.current_bid' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Invoice.current_bid'
        db.alter_column(u'app_invoice', 'current_bid_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['app.Offer']))
    ...
    models = {
        ...
        u'app.invoice': {
            ...
            'buyer_inv_key': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'current_bid': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'current_invoice'", 'unique': 'True', 'null': 'True', 'to': u"orm['app.Offer']"}),
            'date_approved': ('django.db.models.fields.DateTimeField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'due_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
