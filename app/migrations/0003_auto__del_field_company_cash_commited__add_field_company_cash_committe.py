...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Company.cash_commited'
        db.delete_column(u'app_company', 'cash_commited')

        # Adding field 'Company.cash_committed'
        db.add_column(u'app_company', 'cash_committed',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Deleting field 'HistoricalCompany.cash_commited'
        db.delete_column(u'app_historicalcompany', 'cash_commited')

        # Adding field 'HistoricalCompany.cash_committed'
        db.add_column(u'app_historicalcompany', 'cash_committed',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Company.cash_commited'
        db.add_column(u'app_company', 'cash_commited',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Company.cash_committed'
        db.delete_column(u'app_company', 'cash_committed')

        # Adding field 'HistoricalCompany.cash_commited'
        db.add_column(u'app_historicalcompany', 'cash_commited',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Deleting field 'HistoricalCompany.cash_committed'
        db.delete_column(u'app_historicalcompany', 'cash_committed')
    ...
    models = {
        u'app.company': {
            ...
            'cash_committed': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '2'}),
            ...
            'suppliers': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'buyers'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['app.Company']"}),
